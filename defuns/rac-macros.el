...
(fset 'rac-exit-sketch
      (lambda (&optional arg) "Keyboard macro." (interactive "p")
        (kmacro-exec-ring-item
         (quote ([?\M-< ?\C-s ?\( ?q ?/ ?e ?x ?i ?t return ?\M-b ?\M-b ?\C-b backspace backspace ?\C-c ?\C-c] 0 "%d")) arg)))

(fset 'rac-start-sketch
      (lambda (&optional arg) "Keyboard macro." (interactive "p")
        (kmacro-exec-ring-item
         (quote ([?\M-< ?\C-s ?\( ?q ?/ ?e ?x ?i return ?\C-\M-b ?\C-\M-b ?# ?_ ?\C-c ?\C-k ?y] 0 "%d")) arg)))
